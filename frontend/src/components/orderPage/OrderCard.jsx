...
const OrderCard = ({handleOrderCardClick, order}) => {
  const itemsQty = order.items.length;
  return (
    <div onClick={() => handleOrderCardClick(order)} className='flex items-center bg-slate-50 shadow-md rounded-lg gap-5 w-full px-4 py-2 mb-4 cursor-pointer'>
